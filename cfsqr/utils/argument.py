...
def arg_parse_exp_node_ba_shapes():
    ...
    parser.add_argument("--output", dest="output", type=str, default="./", help="folder where pickled files and logs will be stored")
    parser.add_argument("--edge_additions", type=str, default="False", choices=["True", "False"])
    return parser.parse_args()
...
def arg_parse_exp_node_small_amazon():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset", dest="dataset", type=str, default="small_amazon",
                        help="choose a node explanation task")
    parser.add_argument("--model_path", dest="model_path", type=str, default="log/small_amazon_logs",
                        help="path to the model that need to be explained")
    parser.add_argument("--gpu", dest="gpu", action="store_true", help="whether to use gpu")
    parser.add_argument("--cuda", dest="cuda", type=str, default='0', help="which cuda")
    parser.add_argument("--weight_decay", dest="weight_decay", type=float, default='0.005', help="L2 norm to the wights")
...
def arg_parse_exp_node_cora():
    ...
    parser.add_argument("--dataset", dest="dataset", type=str, default="cora",
                        help="choose a node explanation task")
    parser.add_argument("--model_path", dest="model_path", type=str, default="log/cora_logs",
                        help="path to the model that need to be explained")
    parser.add_argument("--gpu", dest="gpu", action="store_true", help="whether to use gpu")
    parser.add_argument("--cuda", dest="cuda", type=str, default='0', help="which cuda")
    parser.add_argument("--weight_decay", dest="weight_decay", type=float, default='0.005', help="L2 norm to the wights")
...
def arg_parse_exp_node_citeseer():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset", dest="dataset", type=str, default="citeseer",
                        help="choose a node explanation task")
    parser.add_argument("--model_path", dest="model_path", type=str, default="log/citeseer_logs",
                        help="path to the model that need to be explained")
    parser.add_argument("--gpu", dest="gpu", action="store_true", help="whether to use gpu")
    parser.add_argument("--cuda", dest="cuda", type=str, default='0', help="which cuda")
    parser.add_argument("--weight_decay", dest="weight_decay", type=float, default='0.005', help="L2 norm to the wights")
