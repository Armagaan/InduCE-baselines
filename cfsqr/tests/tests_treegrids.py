"""Node classification baselines for treegrids"""
...
## * Accurcy
G_dataset = tree_grids_preprocessing(
    dataset_dir="datasets/Tree_Grids",
    hop_num=4
)
...
base_model.load_state_dict(
    torch.load("cfgnn_model_weights/gcn_3layer_syn5.pt")
)
base_model.eval()
