...
from models.gcn import GCNNodeCora
from utils.preprocessing.cora_preprocessing import \
    CoraDataset, cora_preprocessing
...
if __name__ == "__main__":
    ...
    # Our eval set
    test_indices = np.load('datasets/Eval-sets/eval-set-cora.pkl', allow_pickle=True)

    G_dataset = cora_preprocessing(dataset_dir="datasets/cora", hop_num=4)
    ...
    base_model.load_state_dict(torch.load("cfgnn_model_weights/gcn_3layer_cora.pt"))
